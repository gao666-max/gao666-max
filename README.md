...
> 软件工程大二 | AI Native Builder | 用 AI 解决真实问题

### 关于我

- 天津师范大学软件工程 2024 级，C++ 方向
- 重度 AI 工具使用者：Claude Code / Cursor / TRAE SOLO / DeepSeek API
- 相信 AI 不是用来"写作业"的，是用来**把想法变成产品**的
- 享受从真实需求出发 → 设计 AI workflow → 快速交付的完整闭环
